...
<!-- <title>Achievements</title> -->
    ...
    <div class="card text-dark mb-5">
        ...
        <div class="card-img-overlay history-text">
            <h5 class="card-title history-h ">Academic Achievements</h5>
    ...
    <div class="container full">
        <div class="card mb-3 even" style="max-width: 1080px;">
            <div class="row g-0">
                <div class="col-md-4 ">
                    <img id="history-img" src="../images/olimpiyad.jpg" class="img-fluid rounded-start" alt="...">
                </div>
                <div class="col-md-8">
                    <div class="card-body">
        ...
        <div class="card mb-3 odd" style="max-width: 1080px;">
            <div class="row g-0 ">
                ...
                <div class="col-md-4">
                    <img src="../images/island1.jpg" class="img-fluid rounded-start" alt="...">
                </div>
        ...
        <div class="card mb-3 even" style="max-width: 1080px;">
            <div class="row g-0">
                <div class="col-md-4">
                    <img id="history-img" src="../images/hondama_lamaya.jpg" class="img-fluid rounded-start" alt="...">
                </div>
                <div class="col-md-8">
                    <div class="card-body">
                        <h5 class="card-title">Card title</h5>
