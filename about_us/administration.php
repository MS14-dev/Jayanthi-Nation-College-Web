...
<?php
    ...
    <div class="card text-dark">
        ...
        <div class="card-img-overlay">
            <h5 class="card-title abt-text">Administration</h5>
        </div>-
    </div>
        ...
        <div class="row ">
            <div class="col-lg-3 col-sm-3 col-md-3 col-xs-3 ">
                ...
                <a href="administration.php">
                    <h6 class="selected" style="color: #f1c40f;">Administration</h6>
                </a>
                <a href="badge.php">
                    <h6>Badge</h6>
                </a>
            ...
            <div class="col-lg-9 col-sm-9 col-md-9 col-xs-9 right-sec">
                <div class="row ">
                    <div class="col-md-5 col-sm-5  principle">
                        <di class="card text-center">
                            <div class="card-block">
                                <img src="../images/principle.jpg" alt="" class="img-fluid">
